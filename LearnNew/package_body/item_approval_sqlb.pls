...
--Mod Ref:     DefNBS022049
--Mod Details: Added new function TSL_CHECK_RP_STATUS to check if ratio pack is approved.
--           : Modified function UPDATE_STATUS to check if item is Approved.
--           : and to call function TSL_CHECK_RP_STATUS which will intern set the variables.
--------------------------------------------------------------------------------------------
...
--Mod Ref    : CR381
--Mod Details: Make the MU item common only if the item is linked with a statndard item which is authorized
--             in the other country.
------------------------------------------------------------------------------------------------------
--Mod By     : Chandrachooda, chandrachooda.hirannaiah@in.tesco.com
--Mod Date   : 23-Mar-2011
--Mod Ref    : DefNBS022053
--Mod Details: Fixed the CR381 defect
------------------------------------------------------------------------------------------------------
--Mod By     : Suman Guha Mustafi, suman.mustafi@in.tesco.com
--Mod Date   : 26-Mar-2011
--Mod Ref    : DefNBS022105
--Mod Details: Fixed the CR381 defect
------------------------------------------------------------------------------------------------------
-- Mod By     : Suman Guha Mustafi, suman.mustafi@in.tesco.com
-- Mod Date   : 30-Mar-2011
-- Mod Ref    : MrgNBS022146, Merge from 3.5j to 3.5b
-- Mod Details: Merged changes for MrgNBS022146, CR381 and DefNBS021824
-------------------------------------------------------------------------------------------------------
--Mod By:      Shireen Sheosunker, shireen.sheosunker@uk.tesco.com
--Mod Date:    28-Apr-2011
--Mod Ref:     CR392
--Mod Details: Amended APPROVAL_CHECK function to check if there is atleast one ean before approving MU item
------------------------------------------------------------------------------------------------------------
--Mod By:      Phil Noon, phil.noon@uk.tesco.com
--Mod Date:    04-May-2011
--Mod Ref:     DefNBS022489
--Mod Details: Amended APPROVAL_CHECK function to allow retail barcode for MU item to be unapproved.
------------------------------------------------------------------------------------------------------------
--Mod By:      Shireen Sheosunker, shireen.sheosunker@uk.tesco.com
--Mod Date:    06-May-2011
--Mod Ref:     CR392
--Mod Details: Undid CR392 and DefNBS022489 changes for Merge to PrdSi MrgNBS018822
------------------------------------------------------------------------------------------------------------
--Mod By     : Accenture/Ravi Nagaraju, ravi.nagaraju@in.tesco.com
--Mod Date   : 11-May-2011
--Mod Ref    : DefNBS022553
--Mod Details: Fixed the CR381 defect
------------------------------------------------------------------------------------------------------
...
--Mod Date   : 11-May-2011
--Mod Ref    : IM728158/NBS00022585
--Mod Details: Modified APPROVAL_CHECK function
------------------------------------------------------------------------------------------------------------
-- Mod By     : Suman Guha Mustafi, suman.mustafi@in.tesco.com
-- Mod Date   : 23-June-2011
-- Mod Ref    : DefNBS023046(NBS00023046)
-- Mod Details: Record lock exception added in UPDATE_STATUS(),PROCESS_ITEM(),WORKSHEET(),SUBMIT(),
--            : PROCESS_COMP_ITEMS() and TSL_UPDATE_SCA()
------------------------------------------------------------------------------------------------------------
-- Mod By     : Gareth Jones
-- Mod Date   : 28-June-2011
-- Mod Ref    : MrgNBS023061 (merge from PrfNBS023090 on 3.5b)
-- Mod Details: Modified SUBMIT function for performance of C_LOCK_ITEM_MASTER cursors.  SPlit into 4 cursors
--for performance improvement, as full table scans were happening with the OR statements.
-------------------------------------------------------------------------------------------------------------
--Mod By     : Vinutha Raju,vinutha.raju@in.tesco.com
--Mod Date   : 08-Sep-2011
--Mod Ref    : DefNBS023439
------------------------------------------------------------------------------------------------------
-- Mod By    :  shweta.madnawat@in.tesco.com
-- Mod Date  :  25-Oct-2011
-- Def Ref   :  CR434
-- Def Details: Modified function APPROVAL_CHECK for CR434, to ensure that before a multipack is
--              approved, its retail price in teh restricted price event zone is at least
--              multipack qty times the minimum selling retail of its linked single level2 item.
----------------------------------------------------------------------------------------------------
-- Mod By    :  Vatan Jaiswal, vatan.jaiswal@in.tesco.com
-- Mod Date  :  02-Dec-2011
-- Def Ref   :  DefNBS024011
-- Def Details: Modified function APPROVAL_CHECK.
----------------------------------------------------------------------------------------------------
-- Mod By     : Usha Patil/Bhargavi P, usha.patil@in.tesco.com/bharagavi.pujari@in.tesco.com
-- Mod Date   : 30-Dec-2011
-- Mod Ref    : N169
-- Mod Details: Added new function TSL_INSERT_PICKLIST_STATUS to insert into record if any
--              new EAN or new Variant is added to a picklist TPNB and which called in
...
--------------------------------------------------------------------------------------------
--Mod  By      : Usman T
--Mod  Date    : 10-Apr-2014
--Mod  Ref     : NBS00026984
--Mod  Details : CR399: Item bring back to worksheet from Submit state not
--               deleting the records from TSL_ITEM_MIN_PRICE
--------------------------------------------------------------------------------------------------------
...
-- NBS004633, John Alister Anand, 22-Jan-2008, END
   ...
   -- MrgNBS022368, Deepak Gupta/Accenture, deepak.c.gupta@in.tesco.com, 18-Apr-2011, begin
   --03-Mar-2011, CR381, Accenture/Ravi Nagaraju, ravi.nagaraju@in.tesco.com, Begin
   ...
   -- IM728158/NBS00022585, Sathishkumar Alagar/Accenture, satishkumar.alagar@in.tesco.com, 11-May-2011, Begin
   cursor C_CHECK_SUB_TR_RP is
   select 'Y'
     from item_master
    where tran_level < item_level
      and (item_parent            = I_item)
   ...
   L_sub_tr_rp_exists  VARCHAR2(1) := 'N';
   -- IM728158/NBS00022585, Sathishkumar Alagar/Accenture, satishkumar.alagar@in.tesco.com, 11-May-2011, End
   ...
   L_error_key_mu       RTK_ERRORS.RTK_KEY%TYPE := 'INIT';
   --DefNBS022406, 26-Apr-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com end
   --03-Mar-2011, CR381, Accenture/Ravi Nagaraju, ravi.nagaraju@in.tesco.com, End
   -- MrgNBS022368, Deepak Gupta/Accenture, deepak.c.gupta@in.tesco.com, 18-Apr-2011, end
   ---
   ...
   -- 14-Sep-2010, DefNBS019152, Govindarajan K, Govindarajan.Karthigeyan@in.tesco.com, End
   -- MrgNBS022368, Deepak Gupta/Accenture, deepak.c.gupta@in.tesco.com, 18-Apr-2011, begin
   --DefNBS022105, 26-MAR-2011, Suman Guha Mustafi, suman.mustafi@in.tesco.com Begin
   L_mu_uk_store           VARCHAR2(1):= 'N';
   L_mu_roi_store          VARCHAR2(1):= 'N';
   --DefNBS022105, 26-MAR-2011, Suman Guha Mustafi, suman.mustafi@in.tesco.com End
   -- MrgNBS022368, Deepak Gupta/Accenture, deepak.c.gupta@in.tesco.com, 18-Apr-2011, end
   ---
...
BEGIN
               ...
               -- 16-Sep-2010, MrgNBS019188, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com, End
                 ...
                 if L_tocc_req_ind = 'Y' and L_item_master_rec.pack_ind = 'Y' and L_tsl_launch_base_ind = FALSE then
                        ...
                        if L_tocc_subtrans_exists = TRUE then
                          ITEM_APPROVAL_SQL.G_occ_subtran_exist := TRUE;
                        elsif L_tocc_subtrans_exists = FALSE then
                          ITEM_APPROVAL_SQL.G_occ_subtran_exist := FALSE;
                        end if;
              ...
              ---check for Retail barcode auth ind-----
               ...
               -- 16-Sep-2010, MrgNBS019188, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com, End
                 ...
                 if L_tret_req_ind = 'Y' and L_item_master_rec.pack_ind = 'N' then
                  --09-Nov-2009 Tesco HSC/Usha Patil              Mod: CR213 Begin
                    if ITEM_APPROVAL_SQL.TSL_CHECK_TBAN(O_error_message,
                                                        L_tban_type,
                                                        L_item_master_rec.item_number_type) = FALSE then
                       return FALSE;
                    end if;
                  ...
                  --09-Nov-2009 Tesco HSC/Usha Patil              Mod: CR213 End
                        ...
                        if L_tret_subtrans_exists = FALSE
                           -- DefNBS022489 , phil.noon@uk.tesco.com , 04-May-2011 , Begin
                           -- MrgNBS018822, 06-May-2011, Shireen Sheosunker           (BEGIN)
                           -- MrgNBS022598, 13_May-2011, Chitra, chitraprabha.vadakkedath@in.tesco.com, begin
                            and nvl(L_item_master_rec.tsl_mu_ind,'N') = 'N'
                           -- MrgNBS022598, 13_May-2011, Chitra, chitraprabha.vadakkedath@in.tesco.com, end
                           -- MrgNBS018822, 06-May-2011, Shireen Sheosunker           (END)
                           -- DefNBS022489 , phil.noon@uk.tesco.com , 04-May-2011 , Begin
                        then
                             SQL_LIB.SET_MARK('INSERT',
                                              NULL,
      ...
      if L_item_master_rec.tran_level = L_item_master_rec.item_level then
        ...
        if L_exists then
          ...
          if I_new_status = 'S' and
            L_status not in ('A', 'S') and NOT ITEM_APPROVAL_SQL.G_base_approved then
            if INSERT_ERROR(O_error_message,
                            I_item,
                            'TSL_BASE_NOT_SUBAPP',
                            'Y',
            ...
            if I_new_status = 'A' and
               L_status <> 'A' and NOT ITEM_APPROVAL_SQL.G_base_approved then
              if INSERT_ERROR(O_error_message,
                              I_item,
                              'TSL_BASE_NOT_APP',
                              'Y',
        ...
        ---
         ...
         --CR434 shweta.madnawat@in.tesco.com 25-Oct-2011, Begin
         if ITEM_ATTRIB_SQL.TSL_GET_MULTIPACK_QTY(O_error_message,
                                                  L_multipack_qty,
                                                  I_item) = FALSE then
            return FALSE;
         end if;
         ...
         --DefNBS024011, Vatan Jaiswal, vatan.jaiswal@in.tesco.com, 02-Dec-2011, Begin
         if L_multipack_qty > 1 and L_linked_single is NOT NULL then
         --DefNBS024011, Vatan Jaiswal, vatan.jaiswal@in.tesco.com, 02-Dec-2011, End
            if ITEM_ATTRIB_SQL.TSL_VALID_PRICE(O_error_message,
                                               L_valid_price,
                                               I_item,
                                               L_multipack_qty,
                                               L_linked_single) = FALSE then
               return FALSE;
            end if;
            if not L_valid_price then
               insert into item_approval_error (item,
                                                error_key,
                                                system_req_ind,
                                                override_ind,
                                                ...
                                                (select I_item,
                                                  ...
                                                  where not exists (select 'x'
                                                                      from item_approval_error
                                                                     where item = I_item
                                                                       and error_key = 'TSL_INV_MP_RETAIL'
                                                                       and system_req_ind = 'Y'));
               O_approved := FALSE;
            end if;
         end if;
         --CR434 shweta.madnawat@in.tesco.com 25-Oct-2011, End
         -- IM728158/NBS00022585, Sathishkumar Alagar/Accenture, satishkumar.alagar@in.tesco.com, 11-May-2011, Begin
         -- Checking OCC exists for Ratio Pack
         if L_item_master_rec.pack_ind = 'Y' and L_item_master_rec.simple_pack_ind = 'N'
            and L_item_master_rec.item_level = 1 and L_item_master_rec.tran_level = 1 then
            SQL_LIB.SET_MARK('OPEN','C_CHECK_SUB_TR_RP',I_item,NULL);
            open C_CHECK_SUB_TR_RP;
            SQL_LIB.SET_MARK('FETCH','C_CHECK_SUB_TR_RP',I_item,NULL);
            fetch C_CHECK_SUB_TR_RP into L_sub_tr_rp_exists;
            SQL_LIB.SET_MARK('CLOSE','C_CHECK_SUB_TR_RP',I_item,NULL);
            close C_CHECK_SUB_TR_RP;

            if L_sub_tr_rp_exists = 'N' then
               insert into item_approval_error (item,
                                                error_key,
                                                system_req_ind,
                                                override_ind,
   ...
   ----------------------------------------------------------------------------
     ...
     -----------------------------------------------------------------------------------------------
     -- DefNBS00020505, 18-Jan-2011, Accenture/Uttam Sharma,uttam.sharma@in.tesco.com, Begin
     /*
     if L_item_master_rec.item_level < L_item_master_rec.tran_level then
     ...
     */
     -- DefNBS00020505, 18-Jan-2011, Accenture/Uttam Sharma,uttam.sharma@in.tesco.com, End
     ----------------------------------------------------------------------------------------------
     ...
     ----------------------------------------------------------------------------------------------
         ...
         if L_tsl_product_auth = 'Y' then
            ...
            --L2 non-placeholder items and packs must have children if indicator set
               ...
               if (L_item_master_rec.item_level= L_item_master_rec.tran_level or
                ...
                -- CR392, 28-Apr-2011, Shireen Sheosunker                  (BEGIN)
                -- MrgNBS018822, 06-May-2011, Shireen Sheosunker           (BEGIN)
                -- MrgNBS022598, 13_May-2011, Chitra, chitraprabha.vadakkedath@in.tesco.com, begin
                ...
                then
                -- MrgNBS022598, 13_May-2011, Chitra, chitraprabha.vadakkedath@in.tesco.com, end
                -- CR392, 28-Apr-2011, Shireen Sheosunker                  (END)
                -- MrgNBS018822, 06-May-2011, Shireen Sheosunker           (END)
      ...
      --ModN127, 12-May-2008, Vipindas T.P., vipindas.thekkepurakkal@in.tesco.com End
       --------------------------------------------------------------------
         ...
         -- CR392, Shireen Sheosunker, 28-Apr-2011, BEGIN
         -- Include this check for MU Items
         -- MrgNBS022598, 13_May-2011, Chitra, chitraprabha.vadakkedath@in.tesco.com, begin
         -- MrgNBS018822, 06-May-2011, Shireen Sheosunker           (BEGIN)
         if (L_sub_tr_items_req_ind = 'Y' and L_tsl_launch_base_ind = FALSE) then
          -- LT Defect NBS00013099, 05-Jun-2009, Nitin Gour, nitin.gour@in.tesco.com (BEGIN)
             --and L_item_master_rec.tsl_mu_ind != 'Y'  then
          -- CR392, Shireen Sheosunker, 28-Apr-2011, END
          -- MrgNBS018822, 06-May-2011, Shireen Sheosunker           (BEGIN)
          -- MrgNBS022598, 13_May-2011, Chitra, chitraprabha.vadakkedath@in.tesco.com, end
        ...
        --  end if;
         ...
         if L_tsl_single_instance = 'Y' then
            ...
            -- 19-May-2010, CR288b-Big Fix, Govindarajan K, Govindarajan.Karthigeyan@in.tesco.com, End
               if ITEM_APPROVAL_SQL.TSL_CHECK_COMP_ATTRIB (O_error_message,
                                                           L_sink,
            ...
            if C_CHK_COMMON%NOTFOUND and L_item_master_rec.item_number_type = 'TPNB' then
               O_approved := FALSE;

               SQL_LIB.SET_MARK('INSERT',
                                NULL,
                                'ITEM_APPROVAL_ERROR',
                                'Error Key: TSL_NO_MU_ITEM');
               ...
               insert into item_approval_error (item,
                                         ...
                                         select I_item,
                                          ...
                                          where not exists(select 'x'
                                                             from item_approval_error
                                                            where item = I_item
                                                              and error_key='TSL_NO_MU_ITEM'
                                                              and override_ind = 'Y');

            elsif C_CHK_COMMON%FOUND and L_item_master_rec.item_number_type = 'TPNB' then
               --MU item country id
               if ITEM_ATTRIB_SQL.TSL_GET_ITEM_CTRY_IND(O_error_message,
                                                        I_item,
               ...
               FOR C_rec IN C_EXIST_MU_ITEM LOOP
                  ...
                  --
                     ...
                     if L_muitem_country_id is not null and
                        ...
                        --DefNBS022053, 23-MAR-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com begin
                        L_muitem_country_id <> L_base_country_id /*and
                        L_muitem_country_id <> L_store_cntry*/ then
                        --DefNBS022053, 23-MAR-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com end

                        if L_muitem_country_id = 'U' and L_base_country_id = 'R'
                                                     --DefNBS022406, 26-Apr-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com begin
                                                     and L_error_key_mu is NOT NULL then
                                                     --DefNBS022406, 26-Apr-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com end
                           L_error_key_mu := 'TSL_UK_MU';
                        elsif L_muitem_country_id = 'R' and L_base_country_id = 'U'
                                                        --DefNBS022406, 26-Apr-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com begin
                                                        and L_error_key_mu is NOT NULL then
                                                        --DefNBS022406, 26-Apr-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com end
                           L_error_key_mu := 'TSL_ROI_MU';
                        ...
                        /*
                                                         ...
                                                         and L_error_key_mu is NOT NULL then
                                                         --DefNBS022406, 26-Apr-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com end
                           L_error_key_mu := 'TSL_UKROI_MUBASE';
                        */
                        --DefNBS022406A, 02-May-2011, Chandrachooda, Chandrachooda.Hirannaiah@in.tesco.com end
                        --DefNBS022053, 23-MAR-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com begin
                        /*
                        elsif (L_muitem_country_id = 'U' and L_base_country_id = 'U') and L_store_cntry= 'R' then
                           L_error_key_mu := 'TSL_UK_MU_LOC';
                        elsif (L_muitem_country_id = 'R' and L_base_country_id = 'R') and L_store_cntry= 'U' then
                           L_error_key_mu := 'TSL_ROI_MU_LOC'; */
                        ...
                        --DefNBS022053, 23-MAR-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com begin
                        --DefNBS022406, 26-Apr-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com begin
                        --DefNBS022406, commenting, as this is moved outside the loop
                        /*
                        if L_error_key_mu is NOT NULL then
                           if INSERT_ERROR(O_error_message,
                                           I_item,
                                           L_error_key_mu,
                                           'Y',
                     ...
                     if L_muitem_country_id is not null and
                        ...
                        if (L_muitem_country_id = 'U' and L_base_country_id in ('U','B')) and L_store_cntry= 'R'
                                                      --DefNBS022406, 26-Apr-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com begin
                                                      and L_error_key_mu is NOT NULL then
                                                      --DefNBS022406, 26-Apr-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com end
                           L_error_key_mu := 'TSL_UK_MU_LOC';
                        elsif (L_muitem_country_id = 'R' and L_base_country_id in('R','B')) and L_store_cntry= 'U'
                                                         --DefNBS022406, 26-Apr-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com begin
                                                         and L_error_key_mu is NOT NULL then
                                                         --DefNBS022406, 26-Apr-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com end
                           L_error_key_mu := 'TSL_ROI_MU_LOC';
                        --DefNBS022406A, 02-May-2011, Chandrachooda, Chandrachooda.Hirannaiah@in.tesco.com begin
                        elsif L_muitem_country_id = 'U' and L_base_country_id = 'R' and L_error_key_mu is NOT NULL then
                           L_error_key_mu := 'TSL_UK_MU';
                        elsif L_muitem_country_id = 'R' and L_base_country_id = 'U' and L_error_key_mu is NOT NULL then
                           L_error_key_mu := 'TSL_ROI_MU';
                        elsif L_muitem_country_id = 'B' and L_base_country_id not in ('B','U','R') and L_error_key_mu is NOT NULL then
                           L_error_key_mu := 'TSL_UKROI_MU';
                        /*
                        elsif L_muitem_country_id <> 'B' and L_base_country_id = 'B' and L_error_key_mu is NOT NULL then
                           L_error_key_mu := 'TSL_UKROI_MUBASE';
                        */
                        --DefNBS022406A, 02-May-2011, Chandrachooda, Chandrachooda.Hirannaiah@in.tesco.com end
                        --DefNBS022105, 26-MAR-2011, Suman Guha Mustafi, suman.mustafi@in.tesco.com Begin
                        --DefNBS022194, 08-Apr-2011, Suman Guha Mustafi, suman.mustafi@in.tesco.com Begin
                        elsif (L_muitem_country_id = 'B' and L_base_country_id in ('B','U','R')) and L_store_cntry= 'U' then
                        --DefNBS022194, 08-Apr-2011, Suman Guha Mustafi, suman.mustafi@in.tesco.com End
                           L_mu_uk_store := 'Y';
                           -- DefNBS022553 11-May-2011 Accenture/Ravi Nagaraju, ravi.nagaraju@in.tesco.com Begin
                           -- L_error_key_mu := NULL;
                           -- DefNBS022553 11-May-2011 Accenture/Ravi Nagaraju, ravi.nagaraju@in.tesco.com End
                        --DefNBS022194, 08-Apr-2011, Suman Guha Mustafi, suman.mustafi@in.tesco.com Begin
                        elsif (L_muitem_country_id = 'B' and L_base_country_id in ('B','U','R')) and L_store_cntry= 'R' then
                        --DefNBS022194, 08-Apr-2011, Suman Guha Mustafi, suman.mustafi@in.tesco.com End
                           L_mu_roi_store := 'Y';
                           -- DefNBS022553 11-May-2011 Accenture/Ravi Nagaraju, ravi.nagaraju@in.tesco.com Begin
                           -- L_error_key_mu := NULL;
                  ...
                  --DefNBS022194, 08-Apr-2011, Suman Guha Mustafi, suman.mustafi@in.tesco.com End
                     ...
                     L_error_key_mu := 'TSL_BOTH_MU_LOC';
                     /*
                     if INSERT_ERROR(O_error_message,
                                     I_item,
                                     'TSL_BOTH_MU_LOC',
               ...
               --DefNBS022406, 26-Apr-2011, Chandrachooda, chandrachooda.hirannaiah@in.tesco.com begin
               if L_error_key_mu is NOT NULL
                  --DefNBS023439, 07-Sep-2011, Vinutha/Gurutej, vinutha.raju@in.tesco.com begin
                  and L_error_key_mu <> 'INIT'then
                  --DefNBS023439, 07-Sep-2011, Vinutha/Gurutej, vinutha.raju@in.tesco.com begin
                  if INSERT_ERROR(O_error_message,
                                  I_item,
                                  L_error_key_mu,
...
RETURN BOOLEAN IS
   ...
   L_dummy                  VARCHAR2(1);
   --DefNBS022049 25-Mar-2011 Parvesh parveshkumar.rulhan@in.tesco.com Begin
   L_item                  ITEM_MASTER.ITEM%TYPE;
   --DefNBS022049 25-Mar-2011 Parvesh parveshkumar.rulhan@in.tesco.com End
...
BEGIN
   ...
   if I_new_status = 'A' then
      --DefNBS022049 25-Mar-2011 Parvesh parveshkumar.rulhan@in.tesco.com Begin
      open  C_GET_PARENT_RP;
      fetch C_GET_PARENT_RP into L_item;
      ---
      if C_GET_PARENT_RP%FOUND then
         if TSL_CHECK_RP_STATUS(O_error_message,
                                L_item) = FALSE then
            return FALSE;
         end if;
      end if;
      ---
      close C_GET_PARENT_RP;
      --DefNBS022049 25-Mar-2011 Parvesh parveshkumar.rulhan@in.tesco.com End
...
FUNCTION PROCESS_ITEM(O_error_message       IN OUT RTK_ERRORS.RTK_TEXT%TYPE,
   ...
   -- MrgNBS022368, Deepak Gupta/Accenture, deepak.c.gupta@in.tesco.com, 18-Apr-2011, begin
   -- 30-Mar-2011, MrgNBS022146, Suman Guha Mustafi, suman.mustafi@in.tesco.com, Begin
   -- MrgNBS022368, Deepak Gupta/Accenture, deepak.c.gupta@in.tesco.com, 18-Apr-2011, end
   --Defect NBS021824 Iman Chatterjee 10-Mar-2011  - Begin
   --L_rec_exists      VARCHAR2(1) := NULL;
   L_rec_exists      VARCHAR2(1) := 'N';
   --Defect NBS021824 Iman Chatterjee 10-Mar-2011  - End
   -- MrgNBS022368, Deepak Gupta/Accenture, deepak.c.gupta@in.tesco.com, 18-Apr-2011, begin
   -- 30-Mar-2011, MrgNBS022146, Suman Guha Mustafi, suman.mustafi@in.tesco.com, End
   -- MrgNBS022368, Deepak Gupta/Accenture, deepak.c.gupta@in.tesco.com, 18-Apr-2011, end
   ...
   L_picklist_ind                 SYSTEM_OPTIONS.TSL_PICKLIST_IND%TYPE := NULL;
   ...
   cursor C_RCCQ_DUP(Cp_supplier           ITEM_SUPP_COUNTRY_LOC.SUPPLIER%TYPE,
      ...
      -- 30-Mar-2011, MrgNBS022146, Suman Guha Mustafi, suman.mustafi@in.tesco.com, Begin
      -- MrgNBS022368, Deepak Gupta/Accenture, deepak.c.gupta@in.tesco.com, 18-Apr-2011, end
      --Defect NBS021824 Iman Chatterjee 10-Mar-11 - Begin
      --select 'x'
      select 'Y'
      --Defect NBS021824 Iman Chatterjee 10-Mar-11 - End
      -- MrgNBS022368, Deepak Gupta/Accenture, deepak.c.gupta@in.tesco.com, 18-Apr-2011, begin
      -- 30-Mar-2011, MrgNBS022146, Suman Guha Mustafi, suman.mustafi@in.tesco.com, End
      -- MrgNBS022368, Deepak Gupta/Accenture, deepak.c.gupta@in.tesco.com, 18-Apr-2011, end
  ...
  BEGIN
   ...
   if I_new_status = 'A' then
     ...
     --Fix for NBS00005976 and NBS00006962 by Bahubali Dongare End
            ...
            BEGIN
               ...
               if L_item_level = L_tran_level then
                  ...
                  for recs in C_ITEM_SUPP_CTRY_LOC loop
                     ...
                     -- 30-Mar-2011, MrgNBS022146, Suman Guha Mustafi, suman.mustafi@in.tesco.com, Begin
                     -- MrgNBS022368, Deepak Gupta/Accenture, deepak.c.gupta@in.tesco.com, 18-Apr-2011, end
                     --Defect NBS0121824 Iman Chatterjee 10-Mar-2011  - Begin
      ...
      if L_picklist_ind = 'Y' and L_status != 'A' then
         if L_item_level >= L_tran_level and L_pack_ind = 'N' and I_new_status = 'A' then
            if L_item_level = L_tran_level then
               if ITEM_APPROVAL_SQL.TSL_INSERT_PICKLIST_STATUS (O_error_message,
                                                                I_item,
                                                                -- DefNBS024747, Vinutha Raju, vinutha.raju@in.tesco.com, 24-Apr-12, Begin
...
--N111 Chandru N 24-Jun-08 End
   */
   ...
   -- PrfNBS016258, 17-Feb-2010, Govindarajan K, End
   -- 08-Mar-2010, MrgNBS016573, Merge from 3.5bp1 to 3.5b, End
   ---- DefNBS026984,Usman ,10-Apr-2014,Begin
   --Deleting the Product from min price table if the status in brought back to workshee status
    DELETE FROM tsl_item_min_price tmp
      WHERE tmp.item IN
                  (SELECT iem.item
                     FROM item_master iem
                    WHERE (iem.item = I_item OR iem.item_parent = I_item)
                           AND iem.status = 'W'
                          );
   ---- DefNBS026984,Usman ,10-Apr-2014,End
   ---
    ...
    from system_options;
     ...
     --19-Oct-2007    Wipro/JK ModN22   End
      ...
      --CR399 Niraj C nirajkumar.choudhary@in.tesco.com Begin
        L_item_master_rec     ITEM_MASTER%ROWTYPE;
        L_item_status_tbl     TSL_MIN_PRICE_SQL.ITEM_STATUS_TBL;
     --CR399 Niraj C nirajkumar.choudhary@in.tesco.com Begin
BEGIN
   ...
   if L_original_item_status = 'A' then
     ...
     if O_item_approved = TRUE
        and L_item_master_rec.item_level=L_item_master_rec.tran_level
        and nvl(I_ignore_min_price_ind,'N') ='N' then

        if NOT TSL_MIN_PRICE_SQL.TSL_MIN_PRICE_CHECK_APPROVAL(O_error_message,
                                                              L_item_status_tbl,
                                                              I_item) then
           return FALSE;
        end if;
        if L_item_status_tbl is NOT NULL and L_item_status_tbl.count > 0 then
           FOR i in L_item_status_tbl.first..L_item_status_tbl.last
           LOOP
               if I_item = L_item_status_tbl(i).item then
                 O_item_approved:=L_item_status_tbl(i).approved_status;
              end if;
           END LOOP;
        end if;
     end if;
    ...
    --CR399 Niraj C nirajkumar.choudhary@in.tesco.com Begin
          ...
          and nvl(I_ignore_min_price_ind,'N') ='N' then
             ...
             if L_item_status_tbl is NOT NULL and L_item_status_tbl.count > 0 then
                FOR i in L_item_status_tbl.first..L_item_status_tbl.last
                LOOP
                    if child.item = L_item_status_tbl(i).item then
                      L_child_approved:=L_item_status_tbl(i).approved_status;
                   end if;
                END LOOP;
             end if;
           end if;
               ...
               for rec in c_pack(L_child) loop
                 ...
                 -- DefNBS013690 , Tarun Kumar Mishra , tarun.mishra@in.tesco.com , 29-Jun-2009 , End
                     ...
                     if NOT L_valid_occ then
                       -- DefNBS013907 , Tarun Kumar Mishra , tarun.mishra@in.tesco.com , 14-July-2009 , Begin
                       if ITEM_APPROVAL_SQL.G_occ_subtran_exist = FALSE then
                       -- DefNBS013907 , Tarun Kumar Mishra , tarun.mishra@in.tesco.com , 14-July-2009 , End
                        if NOT INSERT_ERROR(O_error_message,
                                            rec.pack_no,
   ...
   if O_item_approved = TRUE and L_original_item_status != 'A'
                              and NOT ITEM_APPROVAL_SQL.G_var_approval_flg then
   ...
   -- 26-Jun-2008 TESCO HSC/Murali    Mod N111  Begin
                              ...
                              and ITEM_APPROVAL_SQL.G_var_approval_flg then
         if PROCESS_ITEM(O_error_message,
                         'A',
...
return BOOLEAN is
   ...
   --19-Oct-2007    Wipro/JK ModN22    End
   --PrfNBS023090 (MrgNBS023061) 28-Jun-11 Gareth Jones - Split cursor C_LOCK_ITEM_MASTER into 4 cursors for performance.
   cursor C_LOCK_ITEM_MASTER is
      select 'x'
       ...
       where im.item_parent = I_item
         for update nowait;
   --
   cursor C_LOCK_ITEM_MASTER2 is
      select 'x'
        from item_master im
       where im.item_grandparent = I_item
         for update nowait;
   --
   cursor C_LOCK_ITEM_MASTER3 is
      select 'x'
        from item_master im
       where exists ( select 'Y'
         ...
         for update nowait;
   --
   cursor C_LOCK_ITEM_MASTER4 is
      select 'x'
        from item_master im, packitem p1
       where im.item_parent     = p1.pack_no
         and im.simple_pack_ind = 'Y'
         and p1.item_parent     = I_item
         for update of im.item nowait;
   --end PrfNBS023090 (MrtgNBS023061).
   ---
   --CR399 Niraj C nirajkumar.choudhary@in.tesco.com Begin
      L_item_master_rec     ITEM_MASTER%ROWTYPE;
      L_item_status_tbl     TSL_MIN_PRICE_SQL.ITEM_STATUS_TBL;
...
BEGIN
   ...
   if L_original_item_status != 'W' then
     ...
     if O_item_submitted = TRUE
        ...
        if L_item_status_tbl is NOT NULL and L_item_status_tbl.count > 0 then
           ...
           LOOP
               if I_item = L_item_status_tbl(i).item then
                 O_item_submitted:=L_item_status_tbl(i).approved_status;
              end if;
           END LOOP;
        end if;
     end if;
      ...
      --CR399 Niraj C nirajkumar.choudhary@in.tesco.com Begin
            ...
            and nvl(I_ignore_min_price_ind,'N') ='N' then
               ...
               if L_item_status_tbl is NOT NULL and L_item_status_tbl.count > 0 then
                  ...
                  LOOP
                      if child.item = L_item_status_tbl(i).item then
                        L_child_submitted:=L_item_status_tbl(i).approved_status;
                     end if;
                 END LOOP;
               end if;
            end if;
   ...
   if O_item_submitted = FALSE and O_children_submitted = FALSE and L_original_item_status = 'W' then
      ...
      --PrfNBS023090 (MrgNBS023061)- Gareth Jones, 24-Jun-2011.  Amended for performance.
      --- Lock the record
      ...
      --- Lock the record
      open C_LOCK_ITEM_MASTER2;
      fetch C_LOCK_ITEM_MASTER2 into L_dummy;
      close C_LOCK_ITEM_MASTER2;

      --- Lock the record
      open C_LOCK_ITEM_MASTER3;
      fetch C_LOCK_ITEM_MASTER3 into L_dummy;
      close C_LOCK_ITEM_MASTER3;

      --- Lock the record
      open C_LOCK_ITEM_MASTER4;
      fetch C_LOCK_ITEM_MASTER4 into L_dummy;
      close C_LOCK_ITEM_MASTER4;
      --end PrfNBS023090 (MrgNBS023061)
...
FUNCTION PROCESS_COMP_ITEMS(O_error_message       IN OUT RTK_ERRORS.RTK_TEXT%TYPE,
   ...
   L_program                     VARCHAR2(64) := 'ITEM_APPROVAL_SQL.PROCESS_COMP_ITEMS';
   L_item_desc                   ITEM_MASTER.ITEM_DESC%TYPE := NULL;
   L_dept                        DEPS.DEPT%TYPE := NULL;
   L_class                       CLASS.CLASS%TYPE := NULL;
   L_subclass                    SUBCLASS.SUBCLASS%TYPE := NULL;
...
FUNCTION TSL_PACK_CHECK(O_error_message IN OUT RTK_ERRORS.RTK_TEXT%TYPE,
   ...
   RETURN BOOLEAN IS
   ---
   L_program       VARCHAR2(50)    := 'ITEM_APPROVAL_SQL.TSL_PACK_CHECK';
   L_count         NUMBER := 0;
   ---
...
FUNCTION TSL_SUBMIT_VARIANT(O_error_message            IN OUT RTK_ERRORS.RTK_TEXT%TYPE,
                            ...
                            --CR399, 04-Mar-2014, Niraj C, nirajkumar.choudhary@in.tesco.com, End
    return BOOLEAN is
    L_program       VARCHAR2(300)    := 'ITEM_APPROVAL_SQL.TSL_SUBMIT_VARIANT';
...
BEGIN
  ...
  ITEM_APPROVAL_SQL.G_base_approved     := TRUE;
  ITEM_APPROVAL_SQL.G_var_approval_flg  := TRUE;
  -- 26-Jun-2008 TESCO HSC/Murali    Mod N111  End
  FOR C_rec in C_GET_VAR_ITEMS
  LOOP
    if ITEM_APPROVAL_SQL.SUBMIT(O_error_message,
  ...
  ITEM_APPROVAL_SQL.G_base_approved     := FALSE;
  ITEM_APPROVAL_SQL.G_var_approval_flg  := FALSE;
...
FUNCTION TSL_APPROVE_VARIANT(O_error_message            IN OUT RTK_ERRORS.RTK_TEXT%TYPE,
                            ...
                            --CR399, 04-Mar-2014, Niraj C, nirajkumar.choudhary@in.tesco.com, End
    return BOOLEAN is
    L_program       VARCHAR2(300)    := 'ITEM_APPROVAL_SQL.TSL_APPROVE_VARIANT';
...
BEGIN
   ITEM_APPROVAL_SQL.G_base_approved := I_approval_flg;
...
FUNCTION TSL_CHECK_TBAN(O_error_message   IN OUT RTK_ERRORS.RTK_TEXT%TYPE,
   ...
   RETURN BOOLEAN IS
   L_program VARCHAR2(50):= 'ITEM_APPROVAL_SQL.TSL_CHECK_TBAN';
...
FUNCTION TSL_CHECK_COMP_ATTRIB (O_error_message   IN OUT RTK_ERRORS.RTK_TEXT%TYPE,
   ...
   L_program            VARCHAR2(50):= 'ITEM_APPROVAL_SQL.TSL_CHECK_COMP_ATTRIB';
...
FUNCTION TSL_UPDATE_ITEM_ATTR(O_error_message   IN OUT    RTK_ERRORS.RTK_TEXT%TYPE,
   ...
   L_program            VARCHAR2(64)      := 'ITEM_APPROVAL_SQL.TSL_UPDATE_ITEM_ATTR';
...
FUNCTION TSL_UPDATE_SCA(O_error_message   IN OUT    RTK_ERRORS.RTK_TEXT%TYPE,
   ...
   RETURN BOOLEAN IS
   L_program       VARCHAR2(64)      := 'ITEM_APPROVAL_SQL.TSL_UPDATE_SCA';
   L_tomorrow      PERIOD.VDATE%TYPE := LP_vdate+1;
   -- DefNBS023046,Suman Guha Mustafi, suman.mustafi@in.tesco.com,23-June-2011, Begin
   L_table       VARCHAR2(30) := 'TSL_SCA*';
   RECORD_LOCKED EXCEPTION;
   PRAGMA        EXCEPTION_INIT(Record_Locked, -54);
   -- DefNBS023046,Suman Guha Mustafi, suman.mustafi@in.tesco.com,23-June-2011,End
...
FUNCTION TSL_CHECK_RP_COMP (O_error_message   IN OUT RTK_ERRORS.RTK_TEXT%TYPE,
   ...
   L_program            VARCHAR2(50):= 'ITEM_APPROVAL_SQL.TSL_CHECK_RP_COMP';
...
--DefNBS022049 25-Mar-2011 Parvesh parveshkumar.rulhan@in.tesco.com Begin
-----------------------------------------------------------------------------------------------------
-- Function name: TSL_CHECK_RP_STATUS
-- Purpose      : To check if ratio pack is approved.
-----------------------------------------------------------------------------------------------------
FUNCTION TSL_CHECK_RP_STATUS(O_error_message   IN OUT   RTK_ERRORS.RTK_TEXT%TYPE,
                             I_item            IN       ITEM_MASTER.ITEM%TYPE)
RETURN BOOLEAN IS

   L_program                VARCHAR2(40)  := 'ITEM_APPROVAL_SQL.TSL_CHECK_RP_STATUS';
...
EXCEPTION
   when OTHERS then
      O_error_message := sql_lib.create_msg('PACKAGE_ERROR',
                                            ...
                                            to_char(SQLCODE));
      return FALSE;
END TSL_CHECK_RP_STATUS;
-----------------------------------------------------------------------------------------------------
--DefNBS022049 25-Mar-2011 Parvesh parveshkumar.rulhan@in.tesco.com End
-----------------------------------------------------------------------------------------------------
--30-Dec-2011 Tesco HSC/Usha Patil              Mod: N169 Begin
----------------------------------------------------------------------------------------------------
-- Function name: TSL_INSERT_PICKLIST_STATUS
-- Purpose      : Added new function TSL_INSERT_PICKLIST_STATUS to insert into record if any
--                new EAN or new Variant is added to a picklist TPNB and no insert type record
--                exists(with action type 'I').
----------------------------------------------------------------------------------------------------
FUNCTION TSL_INSERT_PICKLIST_STATUS(O_error_message          IN OUT   RTK_ERRORS.RTK_TEXT%TYPE,
...
RETURN BOOLEAN IS
   ...
   L_program                   VARCHAR2(50) := 'ITEM_APPROVAL_SQL.TSL_INSERT_PICKLIST_STATUS';
   -- N169/CR373 14-Mar-2012 Bhargavi P/bharagavi.pujari@in.tesco.com Begin
   L_picklist_appr             VARCHAR2(1) := 'N';
   -- N169/CR373 14-Mar-2012 Bhargavi P/bharagavi.pujari@in.tesco.com End
   L_new_item                  VARCHAR2(1);

   cursor C_PICKLIST_APPR is
   select 'Y'
     from tsl_picklist_status tps
    where tps.action_type in ('I','A')
      and tps.vdate = LP_vdate;

   cursor C_VAR_EAN_ITEM is
   select 'Y'
...
BEGIN
   SQL_LIB.SET_MARK('OPEN',
                    ...
                    'TSL_PICKLIST_STATUS',
                    NULL);
   open C_PICKLIST_APPR;

   SQL_LIB.SET_MARK('FETCH',
                    'C_PICKLIST_APPR',
                    'TSL_PICKLIST_STATUS',
                    NULL);
   fetch C_PICKLIST_APPR into L_picklist_appr;

   if C_PICKLIST_APPR%FOUND then
      SQL_LIB.SET_MARK('CLOSE',
                       'C_PICKLIST_APPR',
                       'TSL_PICKLIST_STATUS',
                       NULL);
      close C_PICKLIST_APPR;
      return TRUE;
   end if;
   ...
   -- N169/CR373 14-Mar-2012 Bhargavi P/bharagavi.pujari@in.tesco.com Begin
   -- DefNBS024747, Vinutha Raju, vinutha.raju@in.tesco.com, 24-Apr-12, Begin
   if L_picklist_appr != 'Y' and I_barcode_move_exch_ind = 'N' then
   -- DefNBS024747, Vinutha Raju, vinutha.raju@in.tesco.com, 24-Apr-12, End
   -- N169/CR373 14-Mar-2012 Bhargavi P/bharagavi.pujari@in.tesco.com End
      SQL_LIB.SET_MARK('OPEN',
                       'C_VAR_EAN_ITEM',
      ...
      SQL_LIB.SET_MARK('FETCH',
                       ...
                       'POS_ITEM_BUTTON, ITEM_MASTER',
                       NULL);
      fetch C_VAR_EAN_ITEM into L_new_item;

      if C_VAR_EAN_ITEM%FOUND then
...
EXCEPTION
   when OTHERS then
      O_error_message := sql_lib.create_msg('PACKAGE_ERROR',
                                            ...
                                            to_char(SQLCODE));
      return FALSE;
END TSL_INSERT_PICKLIST_STATUS;
-----------------------------------------------------------------------------------------------
--30-Dec-2011 Tesco HSC/Usha Patil              Mod: N169 End
-----------------------------------------------------------------------------------------------
END;
